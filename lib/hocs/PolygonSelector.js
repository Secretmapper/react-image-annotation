...
var methods = exports.methods = {
  ...
  onClick: function onClick(annotation, e) {
    ...
    var x = !annotation.geometry || p.length === 0 ? coordOfClick.x : p.sort(function (a, b) {
      return a.x < b.x ? -1 : 1;
    })[0].x;
    var y = !annotation.geometry || p.length === 0 ? coordOfClick.y : p.sort(function (a, b) {
      return a.y < b.y ? -1 : 1;
    })[0].y;
    var width = !annotation.geometry || p.length === 0 ? 0 : p.sort(function (a, b) {
      return a.x > b.x ? -1 : 1;
    })[0].x - x;
    var height = !annotation.geometry || p.length === 0 ? 0 : p.sort(function (a, b) {
      return a.y > b.y ? -1 : 1;
    })[0].y - y;
