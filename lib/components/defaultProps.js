  ...
  renderSelector: function renderSelector(_ref) {
    ...
    switch (annotation.geometry.type) {
      ...
      case _selectors.LineSelector.TYPE:
        return _react2.default.createElement(_Line2.default, { annotation: annotation, color: color });
      case _selectors.PointSelector.TYPE:
        return _react2.default.createElement(_Point2.default, { annotation: annotation, color: color });
      case _selectors.DrawingSelector.TYPE:
        return _react2.default.createElement(_Drawing2.default, { annotation: annotation, color: color });
      case _selectors.PolygonSelector.TYPE:
        return _react2.default.createElement(_Polygon2.default, { annotation: annotation, color: color });
      case _selectors.OvalSelector.TYPE:
        return _react2.default.createElement(_Oval2.default, { annotation: annotation, color: color });
      default:
        return null;
    }
  },
