...
exports.default = {
  ...
  selectors: [_selectors.RectangleSelector, _selectors.PointSelector, _selectors.OvalSelector, _selectors.LineSelector, _selectors.DrawingSelector],
  ...
  renderHighlight: function renderHighlight(_ref3) {
    ...
    switch (annotation.geometry.type) {
      case _selectors.RectangleSelector.TYPE:
        return _react2.default.createElement(_Rectangle2.default, { key: key, annotation: annotation, active: active });
      case _selectors.LineSelector.TYPE:
        return _react2.default.createElement(_Line2.default, { key: key, annotation: annotation, active: active });
      case _selectors.DrawingSelector.TYPE:
        return _react2.default.createElement(_Drawing2.default, { key: key, annotation: annotation, active: active });
      case _selectors.PointSelector.TYPE:
        return _react2.default.createElement(_Point2.default, { key: key, annotation: annotation, active: active });
      case _selectors.OvalSelector.TYPE:
        return _react2.default.createElement(_Oval2.default, { key: key, annotation: annotation, active: active });
      default:
        return null;
    }
  },
