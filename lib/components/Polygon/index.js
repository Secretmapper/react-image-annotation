        ...
        _react2.default.createElement(_reactRnd.Rnd, {
          ...
          onDragStop: function onDragStop(e, d, k) {
            if (!selection && (item.x !== d.x || item.y !== d.y)) {
              ...
              annotation.geometry.x = annotation.geometry.points.sort(function (a, b) {
                return a.x < b.x ? -1 : 1;
              })[0].x;

              annotation.geometry.y = annotation.geometry.points.sort(function (a, b) {
                return a.y < b.y ? -1 : 1;
              })[0].y;

              annotation.geometry.width = annotation.geometry.points.sort(function (a, b) {
                return a.x > b.x ? -1 : 1;
              })[0].x - annotation.geometry.x;

              annotation.geometry.height = annotation.geometry.points.sort(function (a, b) {
                return a.y > b.y ? -1 : 1;
